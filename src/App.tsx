      ...
      <div style={{ minHeight: "100vh", background: "#111", paddingBottom: 64 }}>
        ...
        >
          {visibleCompsFlat.length === 0 ? (
            ...
            <>
              <TypeRow icon={Flame} label="Top compétitions" accent="#E8A33D" items={topComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              <TypeRow icon={Radio} label="En direct" accent="#E74C3C" items={liveComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              <TypeRow icon={Pencil} label="Inscriptions ouvertes" accent="#6C63FF" items={registrationComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              <TypeRow icon={Clock} label="Se termine bientôt" accent="#D35400" items={endingSoonComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              <TypeRow icon={ArrowUp} label="En hausse" accent="#27AE60" items={risingComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              <TypeRow icon={Sparkles} label="Nouveautés" accent="#00B8A9" items={newComps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              {currentUser && <TypeRow icon={Bell} label="Suivies" accent="#3498DB" items={followedTypeItems} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />}
              {currentUser && <TypeRow icon={Check} label="Vos inscriptions" accent="#34495E" items={registeredTypeItems} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />}
              {organizerGroups.map(({ organisateur, comps }) => (
                <TypeRow key={organisateur} icon={Users} label={`Compétitions de ${organisateur}`} accent="#7F8C8D" items={comps} onOpen={handleOpenTypeComp} onOpenComments={handleOpenComments} onOpenShare={handleOpenShare} onRegister={handleRegisterTypeComp} registeredCompIds={registeredCompIds} currentUser={currentUser} />
              ))}
            </>
          )}
        </main>
